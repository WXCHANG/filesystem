...
<body>
	<div class="ant-card-head">
		<div class="ant-card-head-wrapper">
			<div class="ant-card-head-title">账户管理</div>
		</div>
	</div>
	<div class="text-body">
		<br />
		<button id="pop-btn" data-method="offset" data-type="auto"
			class="layui-btn layui-btn-normal" onclick="window.location.href='${pageContext.request.contextPath}/system/addAdmin.jsp'">添加用户</button>
