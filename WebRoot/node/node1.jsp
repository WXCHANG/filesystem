...
<body>
    <div class="ant-card-head">
        <div class="ant-card-head-wrapper">
            <div class="ant-card-head-title">区块节点查询</div>
            <form action="">
                <div class="layui-inline layui-form-item">
                    <div class="layui-input-inline" style="width: 240px;">
                        <i class="layui-icon search">&#xe615;</i>
                        <input id="user" type="text" class="layui-input" name="" layui-filter=""; placeholder="">
                    </div>
                </div>
                <div class="layui-inline layui-form-item">
                    <button id="search" class="layui-btn" lay-submit lay-filter="search">查询</button>
                </div>
            </form>
        </div>
    </div>
