  ...
  /*  if (now < 9 || now > 18) {
    ...
    window.alert = function(str, str2, str3, str4, str5, str6) {
        ...
        this.doOk = function() {
            ...
            //window.open("about:blank", "_self").close()
            window.location.href="../showLicensesJsp.do"
        }
        this.doNo = function() {
            alertFram.style.display = "none";
            shield.style.display = "none";
