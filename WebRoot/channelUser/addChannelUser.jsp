	 ...
	 $.ajax({
         ...
         success: function (data) {
        	 jQuery.each(data.list, function(i,item){  
        		 ...
        		 html +="<option value='"+channelname+"'>"+channelname+"</option>";
              })
	...
	<div class="form-box">
		<form action="addUser.do" id="info"
			...
			<div class="layui-form-item form-group has-feedback">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control layui-input" id="password"
			...
			<div class="layui-form-item form-group has-feedback">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control layui-input" id="pwd2"
						name="password2" >
				</div>
			</div>
			...
			<div class="layui-form-item form-group has-feedback">
				<label class="layui-form-label col-sm-2" for="">通道名</label>
				<div class="col-sm-10">
