	...
	<form id="loginBox"
		...
		<div class="content" style="font-size: 13px;">
			<div class="content_header">
				<div class="title-text" style="margin: 17px 168px;">
					<span class="title-ch">数字资产发行及管理平台</span><span class="line"></span> <span
						class="title-eng">Digital Asset Issuance and Management Platform</span>
				</div>
			</div>
			<div>
				<img src="static/images/blockChain.png"
					style="position: absolute;top: 0;bottom: 0;left: 17%;margin: auto;">
			...
			<div class="container"
				...
				<span>版权所有©2018北京腾信软件科技有限公司</span>
			</div>
		</div>
	</form>
