...
<body>
	...
	<div class="text-body">
		...
		<button id="pop-btn" data-method="offset" data-type="auto"
			class="layui-btn layui-btn-normal" onclick="window.location.href='${pageContext.request.contextPath}/system/addUser.jsp'">添加用户</button>
    ...
    <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="stop">停用</a>
</script>
	<script>
	layui.config({
