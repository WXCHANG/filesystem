...
public class NetworkHelper {
	private static Logger log = LoggerFactory.getLogger(NetworkHelper.class);
	  ...
	  public static void main(String[] args) {
	     if(NetworkHelper.getInstance().isReachIp("101.132.101.109")){
	    	 System.out.println("=======本机可以ping通ip："+"101.132.101.109");
	     }
	     else{
	    	 System.out.println("=======本机ping不通ip："+"101.132.101.109");
	     }
	     if(NetworkHelper.getInstance().isReachNetworkInterfaces("101.132.101.109")){
	    	 System.out.println("=======本机所有网卡可以ping通ip："+"101.132.101.109");
	     }
	     else{
	    	 System.out.println("=======本机所有网卡ping不通ip："+"101.132.101.109");
	     }
	     String localIp = NetworkHelper.getInstance().getReachableIP("101.132.101.109",8080);
	     if(!StringUtils.isBlank(localIp)){
	    	 System.out.println("=======本机可以与ip："+"101.132.101.109"+",port:"+8080+"建立连接的IP："+localIp);
	     }
	     else{
	    	 System.out.println("=======本机不能与ip："+"192.168.126.128"+",port:"+8081+"建立连接的IP");
	     }
	  }
}
