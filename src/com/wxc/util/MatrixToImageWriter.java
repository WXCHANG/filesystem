...
//            BufferedImage image = new BufferedImage(imageW, imageH, BufferedImage.TYPE_INT_RGB);
            ...
            g.drawString("区 块 链 实 验 室     ", startX + 30, startY + 30);
            g.dispose();
  ...
  //二维码表示的内容
    private static String content = "http://139.224.232.212:2018/Traceable/qrcodeContent.do?id=9";

    //存放logo的文件夹
    private static String path = "C:/Users/Admin/Desktop";

    public static void main(String args[]) {
    	createQrcode(path, path, content, "11");
    }
    public static void createQrcode(String logoPath,String path,String content,String fileName){
    	 try {
             ...
             File logoFile = new File(logoPath, "bupt.png");
             ...
             //用来存放带有logo+文字的二维码图片
             String newImageWithText = path + "/"+fileName+".jpg";
             //附加在图片上的文字信息
             String text = "北 京 邮 电 大 学     ";
